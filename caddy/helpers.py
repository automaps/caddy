...
__all__ = ["tags_difference", "tag_two_way_difference", "OpCode", 'convert_opcodes', 'round_tags',
           'get_transformation', 'plot_shapely_geometry', 'random_rgba', 'CONVERT']
...
def convert_opcodes(opcodes: Iterable[Tuple[str, int, int, int, int]]) -> Iterator[Operation]:
...
def plot_shapely_geometry(geom: shapely.geometry.base.BaseGeometry, color: QuadNumber) -> None:
